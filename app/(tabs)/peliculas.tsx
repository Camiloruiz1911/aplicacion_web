...
const styles = StyleSheet.create({
  ...
  scrollbar: {
    ...
    marginTop: 5,
    borderRadius: 2,
    opacity: Platform.OS === 'web' ? 0.8 : 0, // visible en web
  },
  searchInput: {
    height: 45,
    borderColor: '#222',
  ...
  castContainer: { paddingVertical: 10, flexDirection: 'row', flexWrap: 'wrap' },
    ...
    return (
      ...
      >
        ...
        <Image
          ...
          style={[styles.detailPoster, { height: width * 1.2 }]}
          resizeMode="cover"
        />
